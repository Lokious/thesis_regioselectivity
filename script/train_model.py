...
def main():
        ...
        filename_list=[ "S","N", "C","O"]
        #for file in filename_list:
            #input_dataframe = pd.read_csv("../autodata/fingerprint_bit128_radius3_all_data_drop_atom.csv", header=0, index_col=0)
        ...
        #mo_del.run_PCA(sequence_data, group_label, "{}".format("k_mer_sequences"))
            ...
            #                         "sepreate_seed_input128fg_bi_type_bond3_rf{}_{}_bit_info".format(d1,file),i=0)
